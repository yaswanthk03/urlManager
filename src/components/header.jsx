  ...
  return (
    <>
      <nav className="py-4 flex justify-between items-center">
        <Link to="/">
          <img src="/logo.png" className="h-16 rounded-sm" alt="Website Logo" />
        </Link>

        {["/", "/link/", "/dashboard"].includes(
          location.pathname.startsWith("/link/") ? "/link/" : location.pathname
        ) ? (
          <div className="flex gap-4">
            <a
              target="_blank"
              className="mt-2"
              href="https://urlmanger.in/@55UhoZWebsite"
            >
